...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 392, 539));
        ...
        listWidget->setSizeAdjustPolicy(QAbstractScrollArea::SizeAdjustPolicy::AdjustToContents);
        listWidget->setAutoScrollMargin(0);
        listWidget->setItemAlignment(Qt::AlignmentFlag::AlignLeading|Qt::AlignmentFlag::AlignLeft|Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing);
